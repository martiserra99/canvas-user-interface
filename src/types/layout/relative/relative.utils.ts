...
export default function(relative: LayoutType) {
  relative.inner.fun('getChildMaxLeft', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getChildMaxRight', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getChildMaxTop', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getChildMaxBottom', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getChildLeft', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getChildRight', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getChildTop', function(relative: Layout, child: Element) {
    const attachTo = child.layoutParams.get('attachTo');
    const margin = child.layoutParams.get('margin');
  ...
  relative.inner.fun('getChildBottom', function(
    relative: Layout,
    child: Element
  ) {
  ...
  relative.inner.fun('getCoordUsingBias', function(
    _: Layout,
    coords: { start: number; end: number },
    length: number,
    bias: number,
